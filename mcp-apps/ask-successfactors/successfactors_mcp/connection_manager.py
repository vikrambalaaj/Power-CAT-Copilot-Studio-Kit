...
class ConnectionManager:
    ...
    def _seed_default_connections(self) -> None:
        ...
        s4_conn = EnterpriseConnection(
            ...
            environment=self.default_environment,
            data_source_url=os.getenv("S4HANA_API_URL", "https://velora-mcp-s4hana.icyriver-9c0a7af6.uaenorth.azurecontainerapps.io"),
        ...
        sac_conn = EnterpriseConnection(
            ...
            environment=self.default_environment,
            data_source_url=os.getenv("SAC_API_URL", "https://velora-mcp-sac.icyriver-9c0a7af6.uaenorth.azurecontainerapps.io"),
        ...
        prod_conn = EnterpriseConnection(
            ...
            environment=self.default_environment,
            data_source_url=os.getenv("PRODUCTIVITY_AGENT_URL", "https://velora-mcp-productivity.icyriver-9c0a7af6.uaenorth.azurecontainerapps.io"),
            connection_owner="admin.it@velora.ae",
        ...
        facilitator_conn = EnterpriseConnection(
            ...
            environment=self.default_environment,
            data_source_url=os.getenv("FACILITATOR_URL", "https://velora-mcp-facilitator.icyriver-9c0a7af6.uaenorth.azurecontainerapps.io"),
            connection_owner="admin.it@velora.ae",
