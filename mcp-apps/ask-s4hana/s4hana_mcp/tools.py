...
async def s4__get_budget_transfers(
    ...
    """Retrieve budget movement and original-budget records from SAP S/4HANA."""
...
# Authoritative tool specifications: exactly 4 primary finance reports + master data tools
# (s4__get_profit_and_loss is explicitly excluded from discovery)
TOOL_SPECS = [
