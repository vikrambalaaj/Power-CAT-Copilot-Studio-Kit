...
export declare class ActionMode {
...
export declare enum ImageSetPresentationStyle {
    Default = 0,
    Stacked = 1,
    Grid = 2
}
...
export declare enum InputLabelPosition {
    Inline = 0,
    Above = 1
}
...
export declare enum TypeErrorType {
    UnknownType = 0,
    ForbiddenType = 1
}
...
export declare enum CarouselInteractionEvent {
    NavigationNext = 0,
    NavigationPrevious = 1,
    Pagination = 2,
    Autoplay = 3
}
export declare enum ActionRole {
    Button = 0,
    Link = 1,
    Tab = 2,
    Menu = 3,
