...
export declare function truncateText(element: HTMLElement, maxHeight: number, lineHeight?: number): void;
...
export declare function clearElementChildren(element: HTMLElement): void;
export declare function addCancelSelectActionEventHandler(element: HTMLElement): void;
export declare function debounce(fn: (...args: unknown[]) => unknown, delay: number): (...args: unknown[]) => void;
