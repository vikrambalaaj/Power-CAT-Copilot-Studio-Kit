...
export const PATTERN_INHERENT_CATEGORY = {
...
export const PATTERN_INHERENT_SEVERITY = {
...
export function categorizePattern(patternDescription) {
    ...
    if (desc.includes('input variable') ||
        desc.includes('input param') ||
        desc.includes('inputvariable')) {
        return 'Input Variables';
    }
    if (desc.includes('output variable') ||
 ...
 */
export function getPatternSeverity(patternName) {
